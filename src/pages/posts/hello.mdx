...
1. #1. I'm not using async await which might make this more readable
2. #2. That update function is messy (although sometimes necessary due to having full control of the cache)
...
```tsx:title=src/services/menu.js
